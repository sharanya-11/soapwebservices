package com.example.demo.springsoapWebservice.config;
...
public class SoapWSConfig {
	...
	public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema schema) {
		...
		defaultWsdl11Definition.setTargetNamespace("http://www.example.com/demo/springsoapWebservice/loanEligibility");
